function (n, h = c(279, -7), c = c(60, 99, 20), l = c(30, 93), 
    power = c(0.298850574712644, 1.01149425287356), gamma = NULL, 
    fixup = TRUE, alpha = 1, palette = NULL, rev = TRUE, register = NULL, 
