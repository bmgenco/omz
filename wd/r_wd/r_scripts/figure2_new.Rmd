...
packages<-c("stars", "gridExtra", "cowplot", "sf", "ggspatial","stringr","sp", "raster","readr" ,"tidyverse", "ggplot2", "lubridate",  "ggthemes", "data.table", "reshape2", "patchwork", "RColorBrewer", "marmap", "extrafont", "oce", "ncdf4", "raster", "RStoolbox", "cmocean", "metR",  "ggimage", "scales")  # set packages here
...
n<-length(cuts)+1
custom_color<-oce::oceColorsViridis(100)
...
# legend_n<-f.fig2_legend_eyes(offset_1=.1, x_space=80, plot_x=3014, plot_y=252, text_size = 12)
legend_n<-f.fig2_legend_eyes(offset_1=.06, x_space=80, plot_x=3014, plot_y=252, text_size = 6)
```

### plot 2nd legneg for gimp
```{r}
setwd(wd)
setwd(fig)

# pdf("figure_two_2nd_legend.pdf", width =5, height=.46)
pdf("figure_two_2nd_legend_SA.pdf", width =5, height=.46)
legend_n
dev.off()
...
# pdf("figure_two_no_2nd_legend.pdf", height=11 , width =8.5)
pdf("figure_two_no_2nd_legend_SA.pdf", height=11 , width =8.5)
plot_grid(p, legend, ncol=2, rel_widths=c(14,1), align="h")
dev.off()


# pdf("figure_s5_no_2nd_legend.pdf", height=11 , width =8.5)
pdf("figure_s5_no_2nd_legend_SA.pdf", height=11 , width =8.5)
plot_grid(s.p, legend, ncol=2, rel_widths=c(14,1), align="h")
dev.off()
# 
# legends<-plot_grid(legend, legend_n, ncol=1)
# pdf("figure_two_test_plot_legend_flipped_correctly.pdf", height=11 , width =8.5)
