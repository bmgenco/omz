...
```{r}
setwd(robj)
# save(function_variables, m.coast, database,  file="20220201_temp_workspace.RData")
...
function_variables$h.radi<-NA
function_variables$land_buffer<-NA
...
[World Ocean Database](https://www.ncei.noaa.gov/access/world-ocean-database-select/dbsearch.html)
...
[WOA](https://www.ncei.noaa.gov/products/world-ocean-atlas)
[SAMOS](https://samos.coaps.fsu.edu/html/webservices.php)
+nothing done yet
[BCO-DMO - metadata](https://erddap.bco-dmo.org/erddap/search/advanced.html?page=1&itemsPerPage=1000)
...
fasterize(., numobs_raster.odz, field=y$field, fun="sum")
...
*416 grids 
* over median (100)-> 225 grid cells
