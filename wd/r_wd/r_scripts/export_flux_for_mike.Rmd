...
```{r}
data<-f.noise(x=1, h.date=new.h$date, prior=14, post=24)
...
```{r}
sst.dif<-signal_trend.sst-trend.sst
chl.dif<-signal_trend.chl-trend.chl
ef.dif<-signal_trend.ef-trend.ef
...
ts_plot(t.pdo,  t.chl, ts_trend(t.chl), -ts_trend(t.pdo))
