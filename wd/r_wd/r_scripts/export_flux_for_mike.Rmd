...
end<-max(x1$date)%>%as.character()

t<-x1%>%select(.,avg_CHL_mg_m3_day, avg_SST_C, avg_EF_mgC_m2_day ) %>% ts(.,start=start, end=end, frequency =7 )
...
ef_400_st3.5<-full_join(x2, newh, by="date")
