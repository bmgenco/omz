...
- pick window
```{r}
data<-f.tc_poc(x,y,z, s=h_200, pre=18, post=60)
...
### single legend  fro pmuiple plots
```{r}
...
pdf("figure_4_prelim200km_all_tcs.pdf", height=11 , width =8.5)
p
dev.off()
