...
p.breaks<-c(0, 872, 900, 920, (944+920)/2, (964+945)/2, (979+965)/2, 980, 995) %>% round(., 0)
p.breaks<-c(0, 250, 500, 872, 900, 920, 940, 960, 980, 1000) %>% round(., 0)
...
scale_y_continuous(name ="Mean export flux (mgC/m^2/day)", labels = function(x) format(x, scientific = TRUE), sec.axis = sec_axis(~./scale.pres,name="Cyclone eye pressure - millibars (mb)",  breaks = p.breaks))+
