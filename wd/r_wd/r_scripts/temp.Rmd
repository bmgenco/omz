...
middle<-c(plot_x/2, plot_y/2)
  ...
  p<-ggplot(data=empty)+geom_sf(data = circle, color = circle_color, alpha = 0)+
    geom_image(data=new_eye.b, aes(x, y, image = image))+ scale_size_identity()+
...
setwd(wd)
setwd(fig)
pdf("legned_two_test3.pdf", width =width, height=height)
p
dev.off()
