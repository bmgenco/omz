...
h.pts<-st_difference(h.pts, st_combine(st_geometry(cl))) %>% sf::st_crop(., c(xmin=function_variables$tc.lon_min, ymin=function_variables$tc.lat_min, xmax=function_variables$tc.lon_max, ymax=function_variables$tc.lat_max)) #subset by user defined 

# need to remove point in oceans
