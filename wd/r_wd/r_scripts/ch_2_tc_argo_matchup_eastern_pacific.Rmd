...
w<-vector(mode='list', length = length(z))
...
```{r}
y<-vector(mode='list')
y$read_me<-(" this is a list created from first script in ch2 seq , 'ch_2_tc_argo_matchup_eastern_pacific.Rmd'created 2023-10-02 -17:45. $function_variablebles give parameters for selected objects. debugging track issue. Only retunr storms with equal before and after profiles for pefexct strom slection")
