...
total_floats<-select_profiles(lon_lim=c(function_variables$h.lon_min,function_variables$h.lon_max),lat_lim=c(function_variables$h.lat_min, function_variables$h.lat_max), end_date = end.date, start_date="1990-01-01", outside="none", sensor=NULL)
...
### user defined: ####
# prior and post for time frame for argo profiles that fall within spatial selection widnow
...
# space
function_variables$h.lon_max<-west # need to improve here
function_variables$h.lat_max<-north
function_variables$h.lat_min<-south
function_variables$h.lon_min<-east



# radius around TS in m
function_variables$h.radi_1<-100000
function_variables$h.radi_2<-200000
function_variables$h.radi_3<-500000
